...
CREATE TABLE `log` (
  ...
  PRIMARY KEY (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';

/*Data for the table `log` */

insert  into `log`(`logId`,`userName`,`createTime`,`content`,`operation`,`ip`,`module`) values (1,'test','2017-11-29 14:31:04',NULL,'退出',NULL,NULL),(2,'test','2017-11-29 14:31:14',NULL,'登录','192.168.1.17',NULL),(3,'admin','2020-07-30 09:34:10',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(4,'admin','2020-07-31 07:25:58',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(5,'admin','2020-07-31 07:25:58',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(6,'admin','2020-07-31 07:28:17',NULL,'退出',NULL,NULL),(7,'admin','2020-07-31 07:28:28',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(8,'admin','2020-07-31 07:28:28',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(9,'admin','2020-07-31 07:34:23',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(10,'admin','2020-07-31 07:34:23',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(11,'admin','2020-07-31 07:44:14',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(12,'admin','2020-07-31 07:44:14',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(13,'admin','2020-07-31 07:45:29','intercept the method: com.xiaoshu.controller.DeviceController.userListnested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'distinct\' in \'class com.xiaoshu.entity.Device\'','拦截到异常','0:0:0:0:0:0:0:1','/ssm'),(14,'admin','2020-07-31 07:46:28','intercept the method: com.xiaoshu.controller.DeviceController.userListnested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'distinct\' in \'class com.xiaoshu.entity.Device\'','拦截到异常','0:0:0:0:0:0:0:1','/ssm'),(15,'admin','2020-07-31 08:01:37',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(16,'admin','2020-07-31 08:08:04',NULL,'退出',NULL,NULL),(17,'admin','2020-07-31 08:08:14',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(18,'admin','2020-07-31 08:08:14',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(19,'admin','2020-07-31 08:26:20',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(20,'admin','2020-07-31 08:26:20',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(21,'admin','2020-07-31 08:27:16',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(22,'admin','2020-07-31 08:27:16',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(23,'admin','2020-07-31 08:28:08',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(24,'admin','2020-07-31 08:28:08',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(25,'admin','2020-07-31 11:24:19',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(26,'admin','2020-07-31 11:24:19',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(27,'admin','2020-07-31 11:27:49','intercept the method: com.xiaoshu.controller.DeviceController.userListnested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'distinct\' in \'class com.xiaoshu.entity.Device\'','拦截到异常','0:0:0:0:0:0:0:1','/ssm'),(28,'admin','2020-07-31 11:28:12','intercept the method: com.xiaoshu.controller.DeviceController.userListnested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'distinct\' in \'class com.xiaoshu.entity.Device\'','拦截到异常','0:0:0:0:0:0:0:1','/ssm');
...
CREATE TABLE `tb_device` (
  ...
  `device_name` varchar(55) DEFAULT NULL,
  `device_type` varchar(55) DEFAULT NULL,
  `device_ram` varchar(55) DEFAULT NULL,
...
insert  into `tb_device`(`deviceId`,`device_name`,`device_type`,`device_ram`,`color`,`price`,`status`,`createtime`) values (1,'小米','android_Phone','64G','金色',2000,'启用','2018-11-12 00:00:00'),(4,'华为Pad','Androud_Pad','64G','金色',3000,'禁用','2020-07-31 08:17:17');
