        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="txt_search_username" class="form-control" id="txt_search_username" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
							...
							<tr>
								...
								<td colspan="4">
									<select class="form-control" name="deviceType" id = "deviceType" aria-required="true" required>
										<option value="">---请选择---</option>
										 	<option value="Androud_Phone">Androud_Phone</option>
						 					<option value="Androud_Pad">Androud_Pad</option>
